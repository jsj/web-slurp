...
The bundled splitters handle webpack and Turbopack wrappers. They do not reconstruct original source files or support every bundler. See [advanced workflows](advanced-workflows.md).
